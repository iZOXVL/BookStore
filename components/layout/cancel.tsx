...
import bolsaAnimation from '../../public/icons/error.json';
      ...
      <div className="flex items-center w-full justify-center">
        ...
        <Link href="/" className="font-bold text-lg flex items-center mx-4">
          <Image
            width={75}
            height={75}
            className="mx-36 ml-[20.75rem] my-3"
            alt="Aura logo"
            src="/logo.png"
          />
        </Link>
          ...
          <NavigationMenuList className="flex gap-24">
            ...
            <NavigationMenuLink href="/" >
              <div
                ...
                className="text-base px-2 relative group flex items-center cursor-pointer bg-red-600 p-2 rounded-lg"
              >
                ...
                <LottieIcon
                  ...
                  play={hoverCarrito}
                />
              <span className="ml-2 mt-[0.5px]">Cancelar compra</span>
              </button>
                <div
                  className="absolute bottom-0 left-0 w-full h-[2px] bg-secondary scale-x-0 hover:scale-x-100 origin-left transition-transform duration-300"
                />
